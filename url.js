...
var db3 = new sqlite3.Database('/Users/mymac/Desktop/DesktopApplication/Desktop_Application/Browser/api/tmp/db.sqlite3');
var myUrl = 'https://www.w3schools.com/python/trypython.asp?filename=demo_ref_string_replace';  // Replace with your URL
let newRowCounter2 = 0;
let optionValues2 = [];
  ...
  fs.writeFile(
    ...
    err => {
      if (err) {
        ...
        // Here, you can add your notification code. The following is just an example.
        new Notification('Notification Title', { body: 'New data has been written to file.' });
      }
    }
  );
},5000);
